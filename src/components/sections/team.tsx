...
export function Team({ members }: { members: TeamMemberData[] }) {
  const display = members.length > 0 ? members : null;
      ...
      <div className="mx-auto max-w-6xl">
        ...
        {display ? (
              ...
              >
                {member.avatarUrl ? (
                  <Image
                    ...
                    width={56}
                    height={56}
                    className="mx-auto h-14 w-14 rounded-full object-cover border border-line"
                  />
                ) : (
          ...
          <p className="mt-10 text-center text-sm text-ink-faint">
            Echipa va fi afișată aici în curând.
          </p>
        )}
      </div>
    </section>
