...
export interface SessionUser { id: string; username: string; email: string; role: string; emailVerified: boolean; citizenId?: string | null; characterName?: string | null; playtimeHours?: number; avatarUrl?: string | null; bannerUrl?: string | null; avatarFrame?: string; }
