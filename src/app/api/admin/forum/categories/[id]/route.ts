...
const bodySchema = z.object({ name: z.string().min(1).max(60).optional(), description: z.string().max(300).optional(), staffOnlyReplies: z.boolean().optional(), pinned: z.boolean().optional(), position: z.number().int().optional() });
