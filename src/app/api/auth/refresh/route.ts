...
export async function POST(req: Request) {
  ...
  // Rotation: the old refresh token is single-use. Revoking it here means a
  // stolen-and-replayed token gets caught the next time the real owner
  // refreshes (their token will already be revoked).
