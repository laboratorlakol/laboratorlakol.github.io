    ...
    <main className="min-h-screen bg-void px-6 py-24">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mt-10 space-y-8 text-sm text-ink-muted leading-relaxed">
          ...
          <section><h2 className="text-base font-semibold text-ink mb-2">6. Drepturile tale (GDPR)</h2><p>Ai dreptul de acces, rectificare, ștergere, portabilitate și opoziție. Scrie-ne la <a href={`mailto:${CONTACT}`} className="text-signal hover:underline">{CONTACT}</a>. Răspundem în 30 de zile.</p></section>
