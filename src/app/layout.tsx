...
export const metadata: Metadata = {
  ...
  title: {
    default: "FADED ROMANIA ROLEPLAY",
    template: "%s | FADED ROMANIA ROLEPLAY",
  },
  description:
    "Experiența roleplay premium din România. Economie realistă, facțiuni, mafii, business-uri și evenimente pe un server FiveM construit pentru roleplay serios.",
  keywords: [
    "FiveM",
    "roleplay",
    "server romania",
  ...
  openGraph: {
    title: "FADED ROMANIA ROLEPLAY",
    description: "Experiența roleplay premium din România.",
    url: SITE_URL,
